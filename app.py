...
def score():
    ...
    if text=='Minimal Depression':
        return render_template('index1.html', output_text1 = "Your PHQ-9 score is "+str(output), output_text2 = "You have "+text)
    elif text=='Mild Depression':
        return render_template('index2.html', output_text1 = "Your PHQ-9 score is "+str(output), output_text2 = "You have "+text)
    elif text=='Moderate Depression':
        return render_template('index3.html', output_text1 = "Your PHQ-9 score is "+str(output), output_text2 = "You have "+text)
    elif text=='Moderately severe Depression':
        return render_template('index4.html', output_text1 = "Your PHQ-9 score is "+str(output), output_text2 = "You have "+text)
    elif text=='Severe Depression':
        return render_template('index5.html', output_text1 = "Your PHQ-9 score is "+str(output), output_text2 = "You have "+text)
